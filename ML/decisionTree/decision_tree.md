![image-20200813150653246](C:\Users\Administrator\AppData\Roaming\Typora\typora-user-images\image-20200813150653246.png)
...
决策树模型（Decision Tree model）是一个模拟人类决策过程思想的模型。它简单、逻辑清晰、有很强的可解释性。一个不经意，你可能就用到了它！相亲有了解吗？来了解一下？母亲为女孩介绍男朋友，女儿内心的决策过程。
...
![image-20200813150626469](decision_tree.assets/image-20200813150626469.png)

女儿内心的决策过程就是一棵决策树“长成”的过程。由此可见，决策树是一种（倒立的）树形结构，基于“树”结构进行决策，由结点和有向边组成。

·内部结点：某个特征属性（年龄、长相、收入等）的判断，每个分支对应于该判断的一种结果

·外部结点（叶结点）：类别划分（你“见”或“不见”，他都在那里）

![image-20200813150641602](decision_tree.assets/image-20200813150641602.png)
...
![image-20200813150832348](decision_tree.assets/image-20200813150832348.png)
